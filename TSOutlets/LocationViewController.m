...
- (void)initSails
{
    ...
    [sails loadCloudBuilding:@"16d42e7e84384d20b166ad7748046ce5"
                  buildingID:@"557a76461bd2173d390002e0"
                     success:^(void){
                         ...
                         [weakSailsMapView loadFloorMap:[floorNameList objectAtIndex:1]];
                         weakSelf.navigationItem.title = [sails getFloorDescription:[floorNameList objectAtIndex:1]];
    ...
    UIView *mainView = [[UIView alloc] initWithFrame:CGRectMake(-15, 80, 130, 30)];
    mainView.layer.cornerRadius = 15;
    mainView.layer.borderWidth  = 1.5f;
    mainView.layer.borderColor  = ThemeYellow.CGColor;
    [self.view addSubview:mainView];
    
    UILabel* sortLabel = [[UILabel alloc] initWithFrame:mainView.frame];
    [sortLabel setBackgroundColor:[UIColor clearColor]];
    [sortLabel setText:@"1楼"];
    [sortLabel setTextAlignment:NSTextAlignmentCenter];
    [sortLabel setTextColor:ThemeYellow];
    [sortLabel setFont:[UIFont systemFontOfSize:18.f]];
    [self.view addSubview: sortLabel];
    
    UIView *main2View = [[UIView alloc] initWithFrame:CGRectMake(-15, 120, 130, 30)];
    main2View.layer.cornerRadius = 15;
    main2View.layer.borderWidth  = 1.5f;
    main2View.layer.borderColor  = ThemeYellow.CGColor;
    [self.view addSubview:main2View];
    
    UILabel* sort2Label = [[UILabel alloc] initWithFrame:main2View.frame];
    [sort2Label setBackgroundColor:[UIColor clearColor]];
    [sort2Label setText:@"2楼"];
    [sort2Label setTextAlignment:NSTextAlignmentCenter];
    [sort2Label setTextColor:ThemeYellow];
    [sort2Label setFont:[UIFont systemFontOfSize:18.f]];
    [self.view addSubview: sort2Label];
    /*
     ...
     [self.view addSubview:sortImage];*/
    
    UIButton *floor1Button = [[UIButton alloc] initWithFrame:mainView.frame];
    //[sortButton setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.5]];
    [floor1Button setExclusiveTouch:YES];
    [floor1Button setTag:1];
    [floor1Button addTarget:self action:@selector(tappedSort1Button) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:floor1Button];
    
    UIButton *floor2Button = [[UIButton alloc] initWithFrame:main2View.frame];
    //[sortButton setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.5]];
    [floor2Button setExclusiveTouch:YES];
    [floor2Button setTag:2];
    [floor2Button addTarget:self action:@selector(tappedSort2Button) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:floor2Button];
}

- (void)tappedSort1Button
{
    __weak SailsLocationMapView *weakSailsMapView = sailsMapView;
    __weak LocationViewController *weakSelf = self;
