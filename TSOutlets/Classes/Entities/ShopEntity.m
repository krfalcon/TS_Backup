...
+ (ShopEntity *)article2ShopEntity:(NSManagedObject *)article {
    ...
    [shopEntity setFloor:[[article valueForKey:@"floor"] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
    [shopEntity setCoordinateX:[[article valueForKey:@"coordinateX"] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
    [shopEntity setCoordinateY:[[article valueForKey:@"coordinateY"] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
