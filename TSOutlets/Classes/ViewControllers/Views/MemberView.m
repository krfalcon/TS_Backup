...
- (IBAction)tappedMemberButton:(id)sender {
    switch ([sender tag]) {
        ...
        case 20:
            if (_delegate && [_delegate respondsToSelector:@selector(memberViewDidTapButton:)]) {
                [_delegate memberViewDidTapButton:ViewControllerTypeSet];
            }
            break;
        default:
        {
...
- (IBAction)tappedLoginButton:(id)sender {
    ...
    _memberEntity = [MemberEntity getDefaultMemberEntity];
}
...
- (void)initInfoView {
    ...
    if (_memberEntity.nickName != [NSString stringWithFormat:@"<null>"]) {
    ...
    onlinePointsLabel = [[UILabel alloc] initWithFrame:CGRectMake(-30 * self.scale * s, 100 * self.scale * s, 100 * self.scale * s, 50 * self.scale * s)];
    ...
    UIButton *setButton = [[UIButton alloc] initWithFrame:CGRectMake(40 * self.scale * s , 260 * self.scale * s, 141 * self.scale * s , 52 * self.scale * s)];
    [setButton setTag:20];
    [setButton setExclusiveTouch:YES];
    [setButton addTarget:self action:@selector(tappedMemberButton:) forControlEvents:UIControlEventTouchUpInside];
    [infoView addSubview:setButton];
    
    UIImageView *setImage = [[UIImageView alloc] initWithFrame:setButton.bounds];
    [setImage setImage:[UIImage imageNamed:@"MemberView_Set"]];
...
- (void)initLoginView {
    ...
    loginView = [[UIButton alloc] initWithFrame:CGRectMake(190 * self.scale * s + self.frame.size.width * (1 - s), 200 * self.scale * s, 180 * self.scale * s, 380 * self.scale * s)];
    [self addSubview:loginView];
    
    UIButton *forgottenButton = [[UIButton alloc] initWithFrame:CGRectMake(70 * self.scale * s, 20 * self.scale * s, 100 * self.scale * s, 25 * self.scale * s)];
    ...
    phoneTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 70 * self.scale * s, 180 * self.scale * s, 35 * self.scale * s)];
    ...
    passwordTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 120 * self.scale * s, 180 * self.scale * s, 35 * self.scale * s)];
    ...
    UIButton *loginButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 180 * self.scale * s, 180 * self.scale * s, 60 * self.scale * s)];
    ...
    UIButton *registerButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 255 * self.scale * s, 180 * self.scale * s, 45 * self.scale * s)];
    ...
    UIButton *setButton = [[UIButton alloc] initWithFrame:CGRectMake(40 * self.scale * s , 320 * self.scale * s, 141 * self.scale * s , 52 * self.scale * s)];
    [setButton setTag:20];
    [setButton setExclusiveTouch:YES];
    [setButton addTarget:self action:@selector(tappedMemberButton:) forControlEvents:UIControlEventTouchUpInside];
