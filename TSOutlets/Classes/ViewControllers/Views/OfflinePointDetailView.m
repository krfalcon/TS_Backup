...
- (void)getInfo:(NSObject *)memberEntity {
    ...
    for (_offlineHistoryEntity in _offlineHistoryListArray) {
    [pointScrollView addSubview:[self createPointDetailWithFrame:CGRectMake(0, 280 * i * self.scale , pointScrollView.frame.size.width, 280 * self.scale)
                                                        andTitle:_offlineHistoryEntity.tradeNumber
                                                         andTime:_offlineHistoryEntity.tradeTime
                                                     andLocation:_offlineHistoryEntity.tradePlace
                                                        andMoney:_offlineHistoryEntity.tradePrice
                                                       andPoints:_offlineHistoryEntity.tradePoint]];
        h += 280 * self.scale;
        i++;
    }
