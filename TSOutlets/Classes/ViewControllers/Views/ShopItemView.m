...
- (UIView *)createListButtonWithItemEntity:(ItemEntity *)entity andTag:(int)tag {
    UIView *itemView = [[UIView alloc] initWithFrame:CGRectMake(187.5 * (tag % 2) * self.scale + 15 * self.scale, 250 * (tag / 2) * self.scale, 155 * self.scale, 300 * self.scale)];
    
    MDIncrementalImageView *itemImage = [[MDIncrementalImageView alloc] initWithFrame:CGRectMake(10 * self.scale, 12.5 * self.scale, 140 * self.scale, 170.6f * self.scale)];
    [itemImage setImageUrl:[NSURL URLWithString:entity.listImageUrl]];
    [itemView addSubview:itemImage];
    
    UILabel *itemName = [[UILabel alloc] initWithFrame:CGRectMake(10 * self.scale, 185 * self.scale, itemImage.frame.size.width, 20 * self.scale)];
    ...
    UIView *priceView = [[UIView alloc] initWithFrame:CGRectMake(30 * self.scale, 215 * self.scale, 120 * self.scale, 20 * self.scale)];
    ...
    UIView *saleView = [[UIView alloc] initWithFrame:CGRectMake(10 * self.scale, 210 * self.scale, 85 * self.scale, 25 * self.scale)];
