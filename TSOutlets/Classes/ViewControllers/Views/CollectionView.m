...
- (UIView *)createListButtonWithFrame:(CGRect)frame andShopEntity:(ShopEntity *)ety andTag:(int)tag {
    ...
    UILabel *locationArea = [[ UILabel alloc] initWithFrame:CGRectMake(frame.size.width * 0.7f, frame.size.height * 0.65f, frame.size.width * 0.3f, frame.size.height * 0.25)];
