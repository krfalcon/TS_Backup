...
- (void)getInfo {
    ...
    [locationIcon setFrame:CGRectMake(- 9.0f * self.scale, 0 * self.scale, 18 * self.scale, 30 * self.scale)];
...
//    }
    ...
    CarouselScrollView *bigImage = [[CarouselScrollView alloc] initWithFrame:CGRectMake(0, 100 * self.scale, lowerView.frame.size.width, lowerView.frame.size.width * 350.f / 750.f + 30 * self.scale) andImages:_itemEntity.carouselArray andTheme:@"Blue" andRotate:YES andScale:350.f / 750.f];
