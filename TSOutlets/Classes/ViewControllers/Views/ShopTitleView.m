...
- (UIView *)getShopTitleViewWithShopEntity:(ShopEntity *)shopEntity {
    ...
    UIButton *locationButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 150 * self.scale, self.frame.size.height * 0.78, 150 * self.scale, 30 * self.scale)];
