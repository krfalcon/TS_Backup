...
- (id)initWithFrame:(CGRect)frame andColor:(UIColor *)color {
    ...
    if (self) {
        ...
        } else if ([color isEqual:ThemeYellow_255_142_107]) {
            [searchField setTintColor:ThemeYellow_255_142_107];
            [searchField setTextColor:ThemeYellow_255_142_107];
        }
        else {
        ...
        if ([color isEqual:ThemeRed_255_184_194]) {
            ...
            [searchIcon setImage:[UIImage imageNamed:@"SearchTextIcon_Yellow"]];
        }
