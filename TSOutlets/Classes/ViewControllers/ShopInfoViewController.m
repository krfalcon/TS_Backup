...
- (void)shopInfoViewDidTapMapButtonWithShopEntity:(ShopEntity *)shopEntity{
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:shopEntity, @"entity", nil];
    [self pushViewControllerWithViewControllerType:ViewControllerTypeMap andParameter:dic];
}
...
- (void)wheelViewTappedButton3 {
    if (!shopEventView) {
        ...
        NSBlockOperation *operation = [NSBlockOperation blockOperationWithBlock:^(){
            NSArray *rawShopEventArray = [ArticleCoreDataHelper getEventArrayWithShopID:_shopEntity.shopID];
            ...
            [shopEventView setEventListArray:originShopEventArray];
