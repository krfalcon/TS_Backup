...
- (void)initFirstViewWithParameter:(NSDictionary *)parameter {
    ...
    if ([ConfigCoreDataHelper checkIfLatestVersion]) {
        messageView.ifLatest = YES;
    } else {
        messageView.ifLatest = NO;
    }
...
- (void)messageViewDidTapMessageButtonWithMessageEntity:(MessageEntity *)messageEntity {
    switch ([messageEntity.type intValue]) {
        ...
        case 4:
            ...
            break;
        case 5:
            [self pushViewControllerWithViewControllerType:ViewControllerTypeExchangeHistory andParameter:nil];
            break;
        case 6:
            [self pushViewControllerWithViewControllerType:ViewControllerTypeExchangeHistory andParameter:nil];
            break;
